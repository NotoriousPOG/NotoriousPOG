...
| --- | --- |
| [label-printer](https://github.com/NotoriousPOG/label-printer) | Network thermal label designer + quick-print desktop app (ZPL / TSPL, Grandpa's Barn) |
| [camera-weapon-detect](https://github.com/NotoriousPOG/camera-weapon-detect) | Local YOLO review queue for visible firearms (optional Grok crop review) |
| [player-and-base-live-data](https://github.com/NotoriousPOG/player-and-base-live-data) | Arma Reforger server mod: live player + Conflict base JSON snapshots |
| [consignment-suite](https://github.com/NotoriousPOG/consignment-suite) | Local desktop app + web demo for a vendor-mall consignment shop |

## // toolkit

<div align="center">

  <img src="https://skillicons.dev/icons?i=ts,js,react,nextjs,nodejs,bun,python,c,html,css,tailwind,github,linux,powershell&theme=dark" alt="skills" />
...
<div align="center">
  ...
  <img src="https://capsule-render.vercel.app/api?type=waving&height=120&color=gradient&customColorList=12,14,6&section=footer" width="100%" alt="synthwave footer wave" />
